...
const DE: Persona[] = [
  {
    source: 'DE 7/19 statute-verified — persona 1 (acquittal -> mandatory + automatic, no wait)',
    package: 'acquittal -> terminated in favor -> mandatory + automatic, priors irrelevant.',
    record: { title: 'Acquittal', disposition: 'acquitted' },
    answers: { nonconv_pending_de: false },
    expect: { resultKey: 'eligible_favorable_de', reading: 'Acquittal -> terminated in favor (§ 4372(b)), mandatory + automatic, no wait, other record irrelevant. Anti-inquiry honest-no.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 2 (completed PBJ + discharge -> terminated in favor)',
    package: 'Probation Before Judgment completed with a discharge order -> favorable -> automatic.',
    record: { title: 'PBJ (completed + discharged)', disposition: 'deferred' },
    answers: { deferred_de: true, nonconv_pending_de: false },
    expect: { resultKey: 'eligible_favorable_de', reading: 'A completed PBJ with a discharge order is a favorable termination (§ 4372(b)) -> mandatory/automatic, no wait. PBJ = favorable, encoded prominently.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 3 (arrest, no charges 13 mo, pending Title 21 -> (b) mandatory)',
    package: 'arrested, no charges filed in over a year, with a pending unrelated Title 21 charge -> still favorable (Title 21 doesn\'t count as pending).',
    record: { title: 'Arrest, No Charges Filed', disposition: 'dismissed' },
    answers: { nonconv_type_de: 'no_charges' },
    expect: { resultKey: 'eligible_favorable_de', reading: 'Arrest with no charges within a year -> terminated in favor (§ 4372(b)); a pending Title 21 charge does NOT count as pending (§ 4372(f)) -> mandatory, bypasses the pending gate.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 4 (9-yr-old case, unknown disposition, no warrant -> stale-case rule)',
    package: '9-year-old case with unknown disposition, no active warrant / recent activity / non-favorable charges -> § 4372(b)(7) favorable.',
    record: { title: 'Old Case (no disposition)', disposition: 'dismissed' },
    answers: { nonconv_type_de: 'stale', stale_de: true },
    expect: { resultKey: 'eligible_stale_favorable_de', reading: 'STALE-CASE RULE (§ 4372(b)(7)): 7+ yr, no disposition, no warrant/activity/non-favorable charges -> deemed terminated in favor -> mandatory.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 5 (marijuana possession conviction -> immediate, priors irrelevant)',
    package: 'marijuana possession conviction -> § 4373(a)(1)(c) immediate, prior/subsequent convictions irrelevant.',
    record: { title: 'Marijuana Possession', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { conv_type_de: 'marijuana_alcohol' },
    expect: { resultKey: 'eligible_immediate_de', reading: '§ 4373(a)(1)(c): marijuana/paraphernalia possession -> immediate mandatory expungement, priors irrelevant, no wait.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 6 (violations-only case + 3 yr -> mandatory)',
    package: 'violations-only conviction case, 3 yr from conviction -> § 4373(a)(1)(b) mandatory.',
    record: { title: 'Violations-Only Case', charge_type: 'infraction', disposition: 'convicted' },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: true, conv_level_de: 'violation', violation_wait_de: '2022-01-01' },
    expect: { resultKey: 'eligible_mandatory_t1_de', reading: '§ 4373(a)(1)(b): violations-only case, 3 yr (2022+3=2025<2026) -> mandatory tier 1, priors irrelevant.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 7 (misd theft + 5 yr + clean ignoring a Title 21 prior -> mandatory tier 2)',
    package: 'misdemeanor theft, 5 yr, only a Title 21 prior (never counts) -> § 4373(a)(2)(a) mandatory tier 2.',
    record: { title: 'Misdemeanor Theft', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: true, conv_level_de: 'misdemeanor', misd_excl_de: false, misd_priors_de: false, misd5_wait_de: '2020-01-01' },
    expect: { resultKey: 'eligible_mandatory_t2_de', reading: 'A Title 21 prior is stripped before the clean-record test (§ 4372(g)/(h)) -> clean -> mandatory tier 2 at 5 yr (2020+5=2025<2026).' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 8 (16 §4757 felony + 10 yr clean -> mandatory)',
    package: 'enumerated felony (16 § 4757), 10 yr, clean -> § 4373(a)(2)(c) mandatory.',
    record: { title: 'Enumerated Felony (16 § 4757)', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: true, conv_level_de: 'felony', felony_type_de: 'enumerated', felony_dv_de: false, felony_priors_de: false, felony10_wait_de: '2015-01-01' },
    expect: { resultKey: 'eligible_mandatory_t2_felony_de', reading: '§ 4373(a)(2)(c): one of the six enumerated felonies, 10 yr from conviction/release (2015+10=2025<2026), no disqualifying priors -> mandatory.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 9 (resisting-arrest misd -> mandatory-excluded -> 4374(a)(2) 7 yr)',
    package: 'resisting-arrest (1257) misdemeanor -> § 4373(b) excluded -> § 4374(a)(2) 7-yr discretionary.',
    record: { title: 'Resisting Arrest (1257)', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: true, conv_level_de: 'misdemeanor', misd_excl_de: true, misd7_wait_de: '2018-01-01' },
    expect: { resultKey: 'eligible_discretionary_excl_de', reading: 'Resisting arrest is on the § 4373(b) 24-item list -> off the mandatory track -> § 4374(a)(2) discretionary at 7 yr (2018+7=2025<2026).' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 10 (DV misdemeanor -> same 7-yr discretionary route)',
    package: 'domestic-violence misdemeanor (qualifying relationship + listed offense) -> § 4373(b) excluded -> § 4374(a)(2) 7-yr discretionary.',
    record: { title: 'DV Misdemeanor', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: true, conv_level_de: 'misdemeanor', misd_excl_de: true, misd7_wait_de: '2018-01-01' },
    expect: { resultKey: 'eligible_discretionary_excl_de', reading: 'DV crime (two-part test: relationship x listed offense) -> § 4373(b) excluded -> the same 7-yr discretionary route as resisting arrest.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 11 (non-violent Title 11 felony + 7 yr clean -> 4374(a)(3))',
    package: 'non-violent felony not on the enumerated list, 7 yr, clean -> § 4374(a)(3) manifest-injustice petition.',
    record: { title: 'Non-Violent Felony', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: true, conv_level_de: 'felony', felony_type_de: 'other', felony_disc_de: false, disc_oncebar_de: 'neither', felony_disc_wait_de: '2018-01-01' },
    expect: { resultKey: 'eligible_discretionary_felony_de', reading: '§ 4374(a)(3): non-enumerated, non-violent felony, 7 yr (2018+7=2025<2026), no priors -> discretionary manifest-injustice petition (petitioner\'s burden).' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 12 (4201(c) violent felony -> pardon-first)',
    package: 'violent felony (11 § 4201(c) list), not yet pardoned -> § 4375 pardon-first route.',
    record: { title: 'Violent Felony (4201(c))', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: true, conv_level_de: 'felony', felony_type_de: 'other', felony_disc_de: true, felony_pardon_de: false },
    expect: { resultKey: 'pardon_route_de', reading: 'A 4201(c) violent felony is excluded from § 4374 -> pardon-first (§ 4375): unconditional pardon opens a discretionary petition. Not one of the six hard-stops.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 13 (pardoned robbery -> 4375 petition)',
    package: 'robbery (violent) that received an unconditional pardon -> § 4375 discretionary petition.',
    record: { title: 'Robbery (pardoned)', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: true, conv_level_de: 'felony', felony_type_de: 'other', felony_disc_de: true, felony_pardon_de: false },
    expect: { resultKey: 'pardon_route_de', reading: 'Robbery is not on the six-offense hard-stop list -> with an unconditional pardon it becomes expungeable via a § 4375 discretionary petition.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 14 (pardoned murder 2nd -> never)',
    package: 'murder 2nd (635), even pardoned -> § 4375 six-offense hard stop -> never.',
    record: { title: 'Murder 2nd (pardoned)', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: true, conv_level_de: 'felony', felony_type_de: 'other', felony_disc_de: true, felony_pardon_de: true },
    expect: { resultKey: 'ineligible_pardon_neverlist_de', reading: '§ 4375 hard stop: murder 2nd (635) is one of the six never-expungeable even with a pardon (632/635/636/772/773/778).' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 15 (felony after prior felony expungement -> (f)(4)(a) discretionary bar)',
    package: 'felony conviction entered after a prior felony-expungement grant -> § 4372(f)(4)(a) discretionary bar.',
    record: { title: 'Felony After Prior Felony Expungement', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: true, conv_level_de: 'felony', felony_type_de: 'other', felony_disc_de: false, disc_oncebar_de: 'felony_after' },
    expect: { resultKey: 'ineligible_once_felony_de', reading: '§ 4372(f)(4)(a): a felony entered AFTER a prior felony expungement is never discretionarily expungeable (mandatory/automatic paths unaffected).' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 16 (expungement 2021, new discretionary petition -> (f)(4)(b) blocked)',
    package: 'expungement granted 2021; a new discretionary petition in 2026 -> § 4372(f)(4)(b) 10-year bar -> blocked to 2031.',
    record: { title: 'New Discretionary Petition (prior 2021 expungement)', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: true, conv_level_de: 'felony', felony_type_de: 'other', felony_disc_de: false, disc_oncebar_de: 'within10' },
    expect: { resultKey: 'ineligible_once_10yr_de', reading: '§ 4372(f)(4)(b): any expungement in the last 10 yr bars another discretionary one (blocked to 2031) — but mandatory/automatic paths are unaffected.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 17 (unpaid restitution, non-willful -> (l) waiver branch)',
    package: 'otherwise-eligible conviction with unpaid restitution, non-willful -> § 4372(l) court-waiver branch.',
    record: { title: 'Conviction (unpaid restitution, non-willful)', charge_type: 'misdemeanor', disposition: 'convicted', restitution_paid: false },
    answers: { conv_type_de: 'standard', conv_serving_de: false, conv_money_de: false, conv_money_willful_de: true },
    expect: { resultKey: 'eligible_money_waiver_de', reading: '§ 4372(l): non-willful nonpayment lets the court grant anyway and waive/convert the balance -> discretionary waiver branch (not a flat block).' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 18 (reckless driving -> 4374(i) carve-in)',
    package: 'reckless driving (21 § 4175) -> one of the three Title 21 carve-ins -> § 4374(i) discretionary.',
    record: { title: 'Reckless Driving (21 § 4175)', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { conv_type_de: 'traffic', traffic_de: true },
    expect: { resultKey: 'eligible_discretionary_traffic_de', reading: '§ 4374(i): reckless driving is one of only three Title 21 offenses that can be expunged (with 2810 and 4176A) — discretionary only.' },
    now: NOW,
  },
  {
    source: 'DE 7/19 statute-verified — persona 19 (speeding -> never, Title 21)',
    package: 'speeding conviction -> Title 21, not one of the three carve-ins -> never.',
    record: { title: 'Speeding', charge_type: 'infraction', disposition: 'convicted' },
    answers: { conv_type_de: 'traffic', traffic_de: false },
    expect: { resultKey: 'ineligible_traffic_de', reading: 'Speeding is a Title 21 offense outside the 2810/4175/4176A carve-in trio -> never expungeable (§ 4372(f)).' },
    now: NOW,
  },
];
...
const FL: Persona[] = [
  ...
  {
    source: 'Wave 3 - FL persona 2a (money-gate corrected 2026-07-23)',
    package: 'withheld adjudication, grand theft, supervision ENDED, $400 in unpaid court costs -> sealing eligible (§ 943.059 has no financial criterion; money is not a bar).',
    record: { title: 'Grand Theft (adjudication withheld)', disposition: 'convicted', restitution_paid: false, fines_paid: false },
    answers: { prior_relief_fl: false, prior_adjudication_fl: false, disqualified_offense_fl: 'none', supervision_fl: false },
    expect: { resultKey: 'eligible_sealing_fl', reading: '§ 943.059(1)(d): the sealing completion gate is court supervision, not money. Supervision ended -> eligible even with $400 in unpaid court costs; the tree no longer reads restitution/fines here. Exact.' },
    now: NOW,
  },
  {
    source: 'Wave 3 - FL persona 2b (money-gate corrected 2026-07-23)',
    package: 'withheld adjudication, still ON PROBATION because restitution unpaid -> not yet (supervision gate); paying may be what ends supervision.',
    record: { title: 'Grand Theft (adjudication withheld)', disposition: 'convicted', restitution_paid: false, fines_paid: false },
    answers: { prior_relief_fl: false, prior_adjudication_fl: false, disqualified_offense_fl: 'none', supervision_fl: true },
    expect: { resultKey: 'supervision_pending_fl', reading: '§ 943.059(1)(d): still under court supervision -> not yet. Unpaid restitution commonly EXTENDS supervision, so paying may be what ends it — but money is not itself the eligibility bar. Exact.' },
    now: NOW,
  },
  {
...
// IA personas come from Diana's read of Iowa Code §§ 901C.2, 901C.3, and 907.9
// (Iowa Code 2026 edition PDFs at legis.iowa.gov) — the statute-verified rewrite
// that took IA to statute_cited on 2026-07-22, replacing the Wave 6 draft's five
// personas. Iowa "expungement" is confidentiality under § 22.7, not a right to deny
// the record; there is no felony-conviction expungement (deferred judgments aside).
const IA: Persona[] = [
  {
    source: 'IA statute verification (2026-07-22) — persona 1',
    package: 'acquitted at trial 7 months ago, costs paid -> shall-grant.',
    record: { title: 'Acquitted, costs paid', disposition: 'acquitted', disposition_date: '2025-12-01' },
    answers: { entry_ia: 'nonconv', nonconv_ngri_ia: false, nonconv_costs_ia: true, nonconv_waiver_ia: false },
    expect: {
      resultKey: 'eligible_nonconv_ia',
      reading: 'An acquittal with all financial obligations paid and 180+ days elapsed (acquitted 2025-12-01, ~7.5 months before 2026-07-15) -> the court SHALL expunge under § 901C.2.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 2',
    package: 'acquitted, costs unpaid -> blocked by the costs gate; payment first.',
    record: { title: 'Acquitted, costs unpaid', disposition: 'acquitted', disposition_date: '2024-06-01' },
    answers: { entry_ia: 'nonconv', nonconv_ngri_ia: false, nonconv_costs_ia: false },
    expect: {
      resultKey: 'ineligible_costs_ia',
      reading: 'Even an acquittal cannot be expunged until all court costs/fees/financial obligations are paid (§ 901C.2) -> blocked (a "not yet") until the debt clears.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 3',
    package: 'charges dismissed 60 days ago, victim of mistaken identity -> 180-day floor waivable, apply now.',
    record: { title: 'Dismissed, mistaken identity', disposition: 'dismissed', disposition_date: '2026-05-15' },
    answers: { entry_ia: 'nonconv', nonconv_ngri_ia: false, nonconv_costs_ia: true, nonconv_waiver_ia: true },
    expect: {
      resultKey: 'eligible_nonconv_ia',
      reading: 'The 180-day wait is waivable for good cause including mistaken identity (§ 901C.2), so a dismissal 60 days ago with costs paid is eligible to apply now.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 4',
    package: 'charges dismissed by NGRI -> excluded.',
    record: { title: 'Dismissed by reason of insanity', disposition: 'dismissed', disposition_date: '2023-06-01' },
    answers: { entry_ia: 'nonconv', nonconv_ngri_ia: true },
    expect: {
      resultKey: 'ineligible_ngri_ia',
      reading: 'A dismissal by reason of insanity is excluded from § 901C.2 non-conviction expungement -> ineligible.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 5',
    package: 'misdemeanor theft conviction 9 years ago, probation ran 3 of those years, all paid, clean -> eligible — conviction-date anchor means the probation tail doesn\'t matter.',
    record: { title: 'Misdemeanor theft (2017)', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2017-01-01', probation_status: 'completed' },
    answers: { entry_ia: 'misd', misd_priordeferred_ia: false, misd_prioruse_ia: false, misd_excluded_ia: false, misd_bundle_ia: 'one' },
    expect: {
      resultKey: 'eligible_misd_ia',
      reading: 'The § 901C.3 clock runs from the DATE OF CONVICTION (2017-01-01), not sentence completion, so 9+ years clears the 8-year rule regardless of the 3-year probation tail -> the court shall expunge.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 6',
    package: 'misdemeanor conviction 6 years ago -> not yet, 8-yr.',
    record: { title: 'Misdemeanor (2020)', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2020-01-01', probation_status: 'completed' },
    answers: { entry_ia: 'misd', misd_priordeferred_ia: false, misd_prioruse_ia: false, misd_excluded_ia: false, misd_bundle_ia: 'one' },
    expect: {
      resultKey: 'waiting_misd_ia',
      reading: 'A misdemeanor convicted 2020-01-01 is only ~6.5 years out at 2026-07-15 — short of the 8-years-from-conviction § 901C.3 rule -> waiting.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 7',
    package: 'OWI misdemeanor 12 years ago -> never (321J.2).',
    record: { title: 'OWI (§ 321J.2)', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2014-06-01', probation_status: 'completed' },
    answers: { entry_ia: 'misd', misd_priordeferred_ia: false, misd_prioruse_ia: false, misd_excluded_ia: true },
    expect: {
      resultKey: 'ineligible_excluded_ia',
      reading: 'OWI (§ 321J.2) is on the § 901C.3(2) exclusion list -> never expungeable, no matter how much time has passed.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 8',
    package: 'domestic abuse assault misdemeanor -> never (708.2A).',
    record: { title: 'Domestic abuse assault (§ 708.2A)', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2015-06-01', probation_status: 'completed' },
    answers: { entry_ia: 'misd', misd_priordeferred_ia: false, misd_prioruse_ia: false, misd_excluded_ia: true },
    expect: {
      resultKey: 'ineligible_excluded_ia',
      reading: 'Domestic-abuse assault (§ 708.2A) is on the § 901C.3(2) exclusion list -> never expungeable.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 9',
    package: 'two misdemeanors from one shoplifting incident, 9 years out -> bundle in one application.',
    record: { title: 'Two misdemeanors, one shoplifting incident (2017)', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2017-01-01', probation_status: 'completed' },
    answers: { entry_ia: 'misd', misd_priordeferred_ia: false, misd_prioruse_ia: false, misd_excluded_ia: false, misd_bundle_ia: 'same' },
    expect: {
      resultKey: 'eligible_misd_ia',
      reading: 'Multiple misdemeanors from the SAME incident can be bundled into the one application (§ 901C.3(3)); 9+ years from conviction, clean -> eligible.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 10',
    package: 'two misdemeanors from separate years -> only one expungeable, ever — once-per-lifetime choice warning.',
    record: { title: 'Two misdemeanors, separate incidents', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2015-06-01', probation_status: 'completed' },
    answers: { entry_ia: 'misd', misd_priordeferred_ia: false, misd_prioruse_ia: false, misd_excluded_ia: false, misd_bundle_ia: 'separate' },
    expect: {
      resultKey: 'complex_separate_ia',
      reading: 'The one application bundles multiple misdemeanors only if from the same incident (§ 901C.3(3)); separate-incident misdemeanors mean only ONE can ever be expunged -> the once-per-lifetime choice.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 11',
    package: 'person with two prior deferred judgments seeking misdemeanor expungement -> barred by (1)(c).',
    record: { title: 'Two prior deferred judgments', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2014-06-01', probation_status: 'completed' },
    answers: { entry_ia: 'misd', misd_priordeferred_ia: true },
    expect: {
      resultKey: 'ineligible_priordeferred_ia',
      reading: 'Having previously been granted two deferred judgments bars the § 901C.3(1)(c) misdemeanor expungement; the deferred docket survives to enforce it.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 12',
    package: 'felony theft with deferred judgment, probation discharged, all paid -> expunged at discharge (the felony concealment route).',
    record: { title: 'Felony theft, deferred judgment discharged + paid', charge_type: 'felony', disposition: 'deferred', probation_status: 'completed' },
    answers: { entry_ia: 'deferred', deferred_route_ia: 'discharged_paid', deferred_othercount_ia: false },
    expect: {
      resultKey: 'eligible_deferred_ia',
      reading: 'A deferred judgment discharged with all financial obligations paid is expunged at discharge under § 907.9(4)(b) — Iowa\'s only route that can conceal what began as a felony.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 13',
    package: 'deferred judgment discharged with a payment plan, balance outstanding -> discharged but NOT expunged until paid in full.',
    record: { title: 'Deferred judgment, payment plan, balance owed', charge_type: 'felony', disposition: 'deferred', probation_status: 'completed' },
    answers: { entry_ia: 'deferred', deferred_route_ia: 'discharged_plan' },
    expect: {
      resultKey: 'complex_deferred_plan_ia',
      reading: 'A payment plan can DISCHARGE a deferred judgment, but § 907.9(4)(b) does not expunge the record until every financial obligation is fully paid -> discharged, not yet expunged.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 14',
    package: 'deferred judgment on count 1, conviction on count 2 in the same case -> dismissed counts not expungeable while count 2\'s conviction stands.',
    record: { title: 'Deferred count 1, conviction count 2', charge_type: 'felony', disposition: 'deferred', probation_status: 'completed' },
    answers: { entry_ia: 'deferred', deferred_route_ia: 'discharged_paid', deferred_othercount_ia: true },
    expect: {
      resultKey: 'complex_deferred_othercount_ia',
      reading: 'Section 907.9(4)(d) bars expunging the dismissed counts of a case if any count produced an unexpunged conviction; count 2\'s standing conviction blocks it until resolved.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 15',
    package: 'already used 901C.3 in 2021 -> never again.',
    record: { title: 'Prior § 901C.3 expungement used 2021', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2013-06-01', probation_status: 'completed' },
    answers: { entry_ia: 'misd', misd_priordeferred_ia: false, misd_prioruse_ia: true },
    expect: {
      resultKey: 'ineligible_prioruse_ia',
      reading: 'The § 901C.3(3) misdemeanor expungement is once per lifetime; having used it in 2021 bars another -> never again.',
    },
    now: NOW,
  },
  {
    source: 'IA statute verification (2026-07-22) — persona 16',
    package: 'expunged record, asked on a job application whether ever convicted -> attorney-tier answer; no statutory right to deny.',
    record: { title: 'Expunged record, disclosure question', disposition: 'convicted' },
    answers: { entry_ia: 'effects' },
    expect: {
      resultKey: 'effects_disclosure_ia',
      reading: 'Iowa expungement makes the record confidential under § 22.7 but none of the three sections grants a right to deny it exists -> attorney-tier; never promise an honest-no.',
    },
    now: NOW,
  },
];
...
const NV: Persona[] = [
  {
    source: 'NV 7/19 statute-verified — persona 1 (misd trespass, 13 mo, clean -> 1-yr tier)',
    package: 'misdemeanor trespass, 13 months post-sentence, clean -> § 179.245(1)(g) 1-yr tier eligible.',
    record: { title: 'Misdemeanor Trespass', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: false, conv_level_nv: 'misd1', date1_nv: '2025-05-01', cleanliness_nv: true, conv_objection_nv: 'no_objection' },
    expect: { resultKey: 'eligible_nohearing_nv', reading: '1-yr general misd tier (§ 179.245(1)(g)), 13 mo > 1 yr, clean, no objection -> seal without hearing under the presumption.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 2 (misd battery-DV, 5 yr clean -> blocked until 7)',
    package: 'misdemeanor battery constituting domestic violence, 5 yr clean -> § 179.245(1)(e) 7-yr tier not met.',
    record: { title: 'Misdemeanor Battery-DV', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: false, conv_level_nv: 'misd7', date7_nv: '2021-01-01' },
    expect: { resultKey: 'waiting_nv', reading: 'Misd battery-DV (33.018) is on the 7-yr tier (§ 179.245(1)(e)); 2021+7=2028 > 2026 -> blocked until 7.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 3 (2nd-offense DUI misd, 8 yr clean -> 7-yr tier)',
    package: 'second-offense (non-felony) DUI, 8 yr clean -> 7-yr tier eligible.',
    record: { title: 'Second-Offense DUI', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: true, dui_tier_nv: 'second', date7_nv: '2018-01-01', cleanliness_nv: true, conv_objection_nv: 'no_objection' },
    expect: { resultKey: 'eligible_nohearing_nv', reading: 'A non-felony / 484C.400(1)(b) DUI seals via the 7-yr tier (§ 179.245(1)(e)); 2018+7=2025 < 2026 -> eligible.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 4 (3rd-offense felony DUI, no program -> never)',
    package: 'third-offense felony DUI (484C.400(1)(c)), no program -> never-list.',
    record: { title: 'Third-Offense Felony DUI', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: true, dui_tier_nv: 'third_felony' },
    expect: { resultKey: 'ineligible_neverlist_nv', reading: 'A felony DUI (484C.400(1)(c)) with no program is never sealable (§ 179.245(6)).' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 5 (3rd-DUI + 484C.392 program + (1)(b) judgment -> 7-yr carve-back)',
    package: 'third-DUI charge that entered judgment as a second offense (1)(b) via the 484C.392 monitoring program -> 7-yr tier (carve-back).',
    record: { title: 'Third-DUI (484C.392 program, (1)(b) judgment)', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: true, dui_tier_nv: 'third_program', date7_nv: '2018-01-01', cleanliness_nv: true, conv_objection_nv: 'no_objection' },
    expect: { resultKey: 'eligible_nohearing_nv', reading: 'DUI CARVE-BACK (§ 179.245(7)): a third-DUI charge that entered judgment as (1)(b) through the 484C.392 program seals via the 7-yr tier -> rescued from the felony-DUI never-list.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 6 (cat E drug felony, 2.5 yr post-discharge, clean -> eligible)',
    package: 'category E drug felony, 2.5 yr post-discharge, clean -> § 179.245(1)(c) 2-yr tier eligible.',
    record: { title: 'Category E Drug Felony', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: false, conv_level_nv: 'catE', date2_nv: '2024-01-01', cleanliness_nv: true, conv_objection_nv: 'no_objection' },
    expect: { resultKey: 'eligible_nohearing_nv', reading: 'Cat E felony -> 2-yr tier (§ 179.245(1)(c)); 2024-01+2=2026-01 < 2026-07 -> eligible.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 7 (cat B felony, 5 yr, non-traffic misd at yr 3 -> cleanliness fail)',
    package: 'category B felony, 5 yr, but a non-traffic misdemeanor conviction at year 3 -> § 179.245(5) cleanliness fail.',
    record: { title: 'Category B Felony (+misd at yr 3)', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: false, conv_level_nv: 'catBCD', date5_nv: '2020-06-01', cleanliness_nv: false },
    expect: { resultKey: 'ineligible_cleanliness_nv', reading: '§ 179.245(5): a non-traffic conviction inside the waiting window fails the cleanliness requirement even though 5 yr have passed.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 8 (cat A robbery, 10 yr clean -> eligible w/ presumption)',
    package: 'category A robbery (crime of violence), 10 yr clean -> § 179.245(1)(a) 10-yr tier eligible with presumption.',
    record: { title: 'Category A Robbery', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: false, conv_level_nv: 'catA', date10_nv: '2015-01-01', cleanliness_nv: true, conv_objection_nv: 'no_objection' },
    expect: { resultKey: 'eligible_nohearing_nv', reading: 'Cat A / crime of violence -> 10-yr tier (§ 179.245(1)(a)); 2015+10=2025 < 2026, clean -> eligible under the rebuttable presumption.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 9 (sexual offense -> never)',
    package: 'sexual offense (§ 179.245(10)(b) list) -> never-sealable.',
    record: { title: 'Sexual Offense', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: true },
    expect: { resultKey: 'ineligible_neverlist_nv', reading: 'Sexual offenses on the § 179.245(10)(b) 18-item list are never sealable (§ 179.245(6)).' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 10 (residential burglary, 6 yr -> blocked until 10)',
    package: 'residential burglary (205.060), 6 yr -> § 179.245(1)(a) 10-yr tier not met.',
    record: { title: 'Residential Burglary', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: false, conv_level_nv: 'catA', date10_nv: '2020-01-01' },
    expect: { resultKey: 'waiting_nv', reading: 'Residential burglary sits in the 10-yr tier (§ 179.245(1)(a)); 2020+10=2030 > 2026 -> blocked until 10.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 11 (acquittal -> shall-seal any time)',
    package: 'acquittal -> § 179.255(7)(a) court SHALL seal, any time.',
    record: { title: 'Acquittal', disposition: 'acquitted' },
    answers: {},
    expect: { resultKey: 'eligible_acquittal_nv', reading: '§ 179.255(7)(a): acquittal with no evidence of further action -> mandatory seal, no waiting period.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 12 (declination, 3 yr post-arrest, SOL open, no stipulation -> wait)',
    package: 'prosecutor declined, 3 yr post-arrest, SOL still open, no stipulation -> wait to earliest of SOL/8 yr.',
    record: { title: 'Declined Prosecution', disposition: 'dismissed' },
    answers: { nonconv_type_nv: 'declined', declined_nv: false },
    expect: { resultKey: 'waiting_declined_nv', reading: '§ 179.255(7)(b): declination seals only at the earliest of SOL run / 8 yr after arrest / stipulation; none met -> wait.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 13 (prosecutor stipulates -> shall-seal)',
    package: 'otherwise-eligible conviction; prosecutor stipulates -> § 179.245(4) court SHALL seal.',
    record: { title: 'Conviction (prosecutor stipulates)', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: false, conv_level_nv: 'catE', date2_nv: '2023-01-01', cleanliness_nv: true, conv_objection_nv: 'stipulate' },
    expect: { resultKey: 'eligible_stipulate_nv', reading: '§ 179.245(4): a prosecutor stipulation makes the court SHALL apply the presumption and seal.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 14 (no objection in 30 days -> seal without hearing)',
    package: 'otherwise-eligible conviction; no written objection in 30 days -> seal without a hearing.',
    record: { title: 'Conviction (no objection)', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: false, conv_level_nv: 'misd1', date1_nv: '2024-01-01', cleanliness_nv: true, conv_objection_nv: 'no_objection' },
    expect: { resultKey: 'eligible_nohearing_nv', reading: '§ 179.245(4): no written objection within 30 days + findings -> court may seal WITHOUT a hearing.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 15 (objection, no rebuttal evidence -> seal at hearing)',
    package: 'otherwise-eligible conviction; prosecutor objects but presents no rebuttal evidence -> seal at hearing.',
    record: { title: 'Conviction (objection, no rebuttal)', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: false, conv_level_nv: 'catBCD', date5_nv: '2019-01-01', cleanliness_nv: true, conv_objection_nv: 'object' },
    expect: { resultKey: 'eligible_hearing_nv', reading: '§ 179.245(4): on objection, the court SHALL seal UNLESS the objector rebuts the presumption — the burden is on the objector, so no rebuttal evidence -> seal at the hearing.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 16 (decriminalized cannabis possession -> 179.271 free request)',
    package: 'decriminalized cannabis possession conviction -> § 179.271 free written request.',
    record: { title: 'Cannabis Possession (decriminalized)', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { conv_type_nv: 'decriminalized', decrim_nv: false },
    expect: { resultKey: 'eligible_decrim_nv', reading: '§ 179.271: a now-decriminalized offense seals by a FREE written request (10-judicial-day objection window), not the general petition. Not a traffic offense.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 17 (single nonviolent felony + reentry program + 4 yr -> 179.259)',
    package: 'single nonviolent felony, completed a reentry program 4+ yr ago -> § 179.259 early sealing.',
    record: { title: 'Nonviolent Felony (reentry program)', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_nv: 'reentry', reentry_nv: true, reentry_date_nv: '2021-01-01' },
    expect: { resultKey: 'eligible_reentry_nv', reading: '§ 179.259: single nonviolent felony, 4 yr after reentry-program completion (2021+4=2025 < 2026) -> court may seal without hearing. Licensing/Insurance inspection survives.' },
    now: NOW,
  },
  {
    source: 'NV 7/19 statute-verified — persona 18 (sealed -> voting/office/jury restored + firearms notice)',
    package: 'category B felony, 5 yr clean -> eligible; output leads with civil-rights restoration + firearms-not-restored notice.',
    record: { title: 'Category B Felony (rights-restoration focus)', charge_type: 'felony', disposition: 'convicted' },
    answers: { conv_type_nv: 'standard', conv_neverlist_nv: false, conv_dui_nv: false, conv_level_nv: 'catBCD', date5_nv: '2020-01-01', cleanliness_nv: true, conv_objection_nv: 'no_objection' },
    expect: { resultKey: 'eligible_nohearing_nv', reading: 'Item-12 rights test: eligible copy leads with § 179.285 immediate restoration of voting/office/jury rights AND the firearms-not-restored-without-a-pardon notice.' },
    now: NOW,
  },
];
...
// MS personas come from Diana's read of Miss. Code Ann. §§ 99-19-71/-72, 99-15-26/-57/-59,
// 41-29-150, 63-11-30, and the enrolled 2026 HB 1546 (Ch. 430) text of §§ 99-19-71,
// 97-3-54.1, 97-3-54.6 — the statute-verified rewrite that took MS to statute_cited on
// 2026-07-22, replacing the Wave 6 draft's five personas. The felony wait is the
// Ch. 430 THREE-year period (down from five, eff. 7/1/2026).
const MS: Persona[] = [
  {
    source: 'MS statute verification (2026-07-22) — persona 1',
    package: 'felony drug possession, completed 3.5 years ago, all paid, no prior expunction -> ELIGIBLE NOW under the 3-yr wait — reform-headline persona, would have been told "wait 1.5 more years" under old law.',
    record: { title: 'Felony drug possession', charge_type: 'felony', disposition: 'convicted', disposition_date: '2022-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: false, dui_ms: false, level_ms: 'felony', felony_prioruse_ms: false, felony_excluded_ms: false, felony_date_ms: '2023-01-01' },
    expect: {
      resultKey: 'eligible_felony_ms',
      reading: 'Felony possession is not on the exclusion list (that is trafficking, not possession); completed 2023-01-01, the reduced 3-year § 99-19-71(2) wait (Ch. 430, eff. 7/1/2026) is met at 2026-07-15 -> eligible now, where the old 5-year rule would still say wait.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 2',
    package: 'same, completed 2 years ago -> not yet, 3-yr wait.',
    record: { title: 'Felony drug possession (recent)', charge_type: 'felony', disposition: 'convicted', disposition_date: '2024-01-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: false, dui_ms: false, level_ms: 'felony', felony_prioruse_ms: false, felony_excluded_ms: false, felony_date_ms: '2024-07-01' },
    expect: {
      resultKey: 'waiting_ms',
      reading: 'Completed 2024-07-01, only 2 years elapsed at 2026-07-15 — short of even the reduced 3-year § 99-19-71(2) wait -> waiting.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 3',
    package: 'embezzlement felony -> never.',
    record: { title: 'Embezzlement felony', charge_type: 'felony', disposition: 'convicted', disposition_date: '2018-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: false, dui_ms: false, level_ms: 'felony', felony_prioruse_ms: false, felony_excluded_ms: true },
    expect: {
      resultKey: 'ineligible_excluded_ms',
      reading: 'Embezzlement is on the twelve-item § 99-19-71(2) exclusion list -> never expungeable.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 4',
    package: 'promoting-prostitution felony -> never (Ch. 430 addition).',
    record: { title: 'Promoting prostitution felony', charge_type: 'felony', disposition: 'convicted', disposition_date: '2020-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: false, dui_ms: false, level_ms: 'felony', felony_prioruse_ms: false, felony_excluded_ms: true },
    expect: {
      resultKey: 'ineligible_excluded_ms',
      reading: 'Promoting prostitution was added to the § 99-19-71(2) exclusion list by 2026 Ch. 430 -> never expungeable.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 5',
    package: 'two felonies, common nucleus -> one conviction, eligible.',
    record: { title: 'Two felonies, common nucleus', charge_type: 'felony', disposition: 'convicted', disposition_date: '2021-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: false, dui_ms: false, level_ms: 'felony', felony_prioruse_ms: false, felony_excluded_ms: false, felony_date_ms: '2022-06-01' },
    expect: {
      resultKey: 'eligible_felony_ms',
      reading: 'Felonies sharing a common nucleus of operative facts count as a single conviction (§ 99-19-71(2)); with no prior expunction used, and 4 years past completion, the one-shot expunction is eligible.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 6',
    package: 'second felony after prior felony expunction -> never.',
    record: { title: 'Second felony after a prior expunction', charge_type: 'felony', disposition: 'convicted', disposition_date: '2015-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: false, dui_ms: false, level_ms: 'felony', felony_prioruse_ms: true },
    expect: {
      resultKey: 'ineligible_prioruse_ms',
      reading: 'The one-felony-per-lifetime limit (§ 99-19-71(2)), once used, bars a second felony expunction -> never (common-nucleus counting flagged as the one thing to confirm).',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 7',
    package: 'first-offense shoplifting misdemeanor -> eligible now.',
    record: { title: 'First-offense shoplifting misdemeanor', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2023-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: false, dui_ms: false, level_ms: 'misd', misd_type_ms: 'first_nontraffic' },
    expect: {
      resultKey: 'eligible_misd_ms',
      reading: 'A first-offense, non-traffic misdemeanor has no set wait (§ 99-19-71(1)) -> eligible now.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 8',
    package: 'traffic misdemeanor -> not via 71(1).',
    record: { title: 'Traffic misdemeanor', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2022-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: false, dui_ms: false, level_ms: 'misd', misd_type_ms: 'traffic' },
    expect: {
      resultKey: 'ineligible_traffic_ms',
      reading: 'The first-offender misdemeanor path (§ 99-19-71(1)) expressly excludes traffic misdemeanors -> not available via 71(1).',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 9',
    package: 'dismissed felony charge -> shall-grant, $150 fee note.',
    record: { title: 'Dismissed felony charge', charge_type: 'felony', disposition: 'dismissed', disposition_date: '2023-06-01' },
    answers: { nonconv_route_ms: 'felony' },
    expect: {
      resultKey: 'eligible_nonconv_71_ms',
      reading: 'A dismissed felony charge is a non-conviction the court "shall" expunge (§ 99-19-71(4)); the fee trap — subsection (4) OF § 99-19-71 — means the $150 attaches by the statute\'s terms.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 10',
    package: 'misdemeanor arrest, never charged, 14 months -> 99-15-59, no fee statute.',
    record: { title: 'Misdemeanor arrest, never charged', charge_type: 'misdemeanor', disposition: 'dismissed' },
    answers: { nonconv_route_ms: 'misd' },
    expect: {
      resultKey: 'eligible_9959_ms',
      reading: 'A misdemeanor arrest not formally charged within 12 months routes to § 99-15-59, which carries no fee statute -> the cheaper misdemeanor non-conviction route.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 11',
    package: 'DV misdemeanor plea, first offense -> nonadjudication carve-in.',
    record: { title: 'DV misdemeanor non-adjudication plea', charge_type: 'misdemeanor', disposition: 'deferred', probation_status: 'completed' },
    answers: { deferred_route_ms: 'dv_nonadj' },
    expect: {
      resultKey: 'eligible_nonadj_dv_ms',
      reading: 'Domestic-violence misdemeanors (§ 99-3-7(5)) are expressly carved INTO § 99-15-26 non-adjudication eligibility (26(1)(c)) despite looking like crimes against the person -> the surprise-yes carve-in.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 12',
    package: 'trafficking survivor with a shoplifting conviction from the trafficking period, no documentation -> 54.6(6) motion, preponderance, documentation not required — eligible path.',
    record: { title: 'Survivor shoplifting conviction (trafficking period)', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2021-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: true, survivor_violence_ms: false },
    expect: {
      resultKey: 'eligible_survivor_ms',
      reading: 'A misdemeanor committed as a direct result of being trafficked qualifies for a § 97-3-54.6(6) survivor expungement motion, anytime, on a preponderance standard, with official documentation NOT required -> eligible path.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 13',
    package: 'trafficking survivor, robbery conviction -> 54.6(6) barred (crime of violence), route to standard analysis.',
    record: { title: 'Survivor robbery conviction', charge_type: 'felony', disposition: 'convicted', disposition_date: '2019-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: true, survivor_violence_ms: true },
    expect: {
      resultKey: 'survivor_violent_ms',
      reading: 'The § 97-3-54.6(6) survivor expungement reaches only misdemeanors and non-violent felonies, so a crime of violence (§ 97-3-2) like robbery is barred and routes to the standard § 99-19-71 analysis, where a crime of violence is also excluded.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 14',
    package: 'first DUI, BAC .17 -> expunction barred.',
    record: { title: 'First DUI, BAC .17', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2018-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: false, dui_ms: true, dui_offense_ms: 'first', dui_bac_ms: true },
    expect: {
      resultKey: 'ineligible_dui_ms',
      reading: 'First-offense DUI expunction requires a blood-alcohol concentration under .16 where a test result exists (§ 63-11-30(13)); a .17 fails that gate -> barred.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 15',
    package: 'first DUI, prior DUI nonadjudication -> barred (registry cross-burn).',
    record: { title: 'First DUI, prior DUI nonadjudication', charge_type: 'misdemeanor', disposition: 'convicted', disposition_date: '2018-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: false, dui_ms: true, dui_offense_ms: 'first', dui_bac_ms: false, dui_prior_ms: true },
    expect: {
      resultKey: 'ineligible_dui_ms',
      reading: 'DUI nonadjudication, expunction, and first-offender status share one DPS registry, so a prior DUI nonadjudication forecloses a later expunction (§ 63-11-30(13)) -> barred (cross-burn).',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 16',
    package: 'fourth DUI -> never.',
    record: { title: 'Fourth DUI', charge_type: 'felony', disposition: 'convicted', disposition_date: '2020-06-01', probation_status: 'completed' },
    answers: { public_official_ms: false, survivor_ms: false, dui_ms: true, dui_offense_ms: 'multi' },
    expect: {
      resultKey: 'ineligible_dui_ms',
      reading: 'A fourth-or-subsequent DUI is a felony that can never be expunged (§ 63-11-30; § 99-19-71(2) exclusion) -> never.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 17',
    package: 'public official, duty-related bribery -> 71(5) bar.',
    record: { title: 'Public-official duty-related bribery', charge_type: 'felony', disposition: 'convicted', disposition_date: '2018-06-01', probation_status: 'completed' },
    answers: { public_official_ms: true },
    expect: {
      resultKey: 'ineligible_publicofficial_ms',
      reading: 'No public official may expunge a conviction related to official duties (§ 99-19-71(5)); the bar is screened first and applies across every path -> barred.',
    },
    now: NOW,
  },
  {
    source: 'MS statute verification (2026-07-22) — persona 18',
    package: 'first-time possession, completed 41-29-150(d) probation -> discharge + expunction application, once-ever warning.',
    record: { title: 'First-time possession, § 41-29-150(d) conditional discharge', charge_type: 'felony', disposition: 'deferred', probation_status: 'completed' },
    answers: { deferred_route_ms: 'drug_cd' },
    expect: {
      resultKey: 'eligible_drugcd_ms',
      reading: 'A completed § 41-29-150(d) conditional discharge is not a conviction; the person may apply to expunge it (d)(2), and the once-per-person limit is the warning. The served-conviction interpretive question is flagged in messaging.',
    },
    now: NOW,
  },
];

// KS personas come from Diana's read of K.S.A. 21-6614, 22-2410, and 12-4516
// (kslegislature.gov), plus 2026 session-law statuses confirmed from the official
// bill pages — the statute-verified rewrite that took KS to statute_cited on
// 2026-07-22, replacing the Wave 6 draft's five personas. Felony/DUI waits run from
// the LATER of sentence satisfaction or discharge; date nodes are asked, not read
// from disposition_date (the anchor is discharge, not the sentencing date).
const KS: Persona[] = [
  {
    source: 'KS statute verification (2026-07-22) — persona 1',
    package: 'nondrug severity-8 felony theft, discharged 4 years ago, no recent felonies -> eligible, 3-yr tier.',
    record: { title: 'Nondrug severity-8 felony theft', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: false, never_list_ks: false, municipal_ks: false, survivor_ks: false, specialty_ks: false, recent_felony_ks: false, dui_ks: false, offense_type_ks: 'felony3', mv_trap_ks: false, date3_ks: '2022-06-01' },
    expect: {
      resultKey: 'eligible_conviction_ks',
      reading: 'A nondrug severity 6-10 felony with no motor-vehicle use sits in the 3-year tier (21-6614(a)); discharged 2022-06-01, past 3 years at 2026-07-15, no recent felony -> eligible.',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 2',
    package: 'severity-7 felony where the getaway car was driven by petitioner -> 5-yr tier via (c)(5) motor-vehicle trap.',
    record: { title: 'Severity-7 felony, motor vehicle used', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: false, never_list_ks: false, municipal_ks: false, survivor_ks: false, specialty_ks: false, recent_felony_ks: false, dui_ks: false, offense_type_ks: 'felony3', mv_trap_ks: true, date3_ks: '2022-06-01', date5_ks: '2022-06-01' },
    expect: {
      resultKey: 'waiting_ks',
      reading: 'The (c)(5) trap pulls ANY felony in which a motor vehicle was used into the 5-year tier; discharged 2022-06-01, only ~4 years at 2026-07-15 -> waiting (it would have been eligible in the 3-year tier, which is exactly the trap).',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 3',
    package: 'drug-grid level-5 possession (2015 offense), discharged 3.5 years -> eligible, 3-yr tier.',
    record: { title: 'Drug-grid level-5 possession', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: false, never_list_ks: false, municipal_ks: false, survivor_ks: false, specialty_ks: false, recent_felony_ks: false, dui_ks: false, offense_type_ks: 'felony3', mv_trap_ks: false, date3_ks: '2023-01-01' },
    expect: {
      resultKey: 'eligible_conviction_ks',
      reading: 'A post-7/1/2012 drug-grid level-5 offense sits in the 3-year tier; discharged 2023-01-01, past 3 years at 2026-07-15 -> eligible.',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 4',
    package: 'class B felony (1990), completed 1998 -> eligible, 5-yr tier long since run.',
    record: { title: 'Pre-1993 class B felony', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: false, never_list_ks: false, municipal_ks: false, survivor_ks: false, specialty_ks: false, recent_felony_ks: false, dui_ks: false, offense_type_ks: 'felony5', date5_ks: '1998-06-01' },
    expect: {
      resultKey: 'eligible_conviction_ks',
      reading: 'A pre-1993 class A/B/C felony sits in the 5-year tier; discharged 1998, decades past 5 years -> eligible.',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 5',
    package: 'involuntary manslaughter -> never (surprise-no).',
    record: { title: 'Involuntary manslaughter', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: false, never_list_ks: true },
    expect: {
      resultKey: 'ineligible_never_ks',
      reading: 'Involuntary manslaughter is on the 21-6614(e) never-expunge list — broader than most states -> never (surprise-no).',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 6',
    package: 'child endangerment misdemeanor -> never (surprise-no).',
    record: { title: 'Child endangerment misdemeanor', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: false, never_list_ks: true },
    expect: {
      resultKey: 'ineligible_never_ks',
      reading: 'Endangering a child is on the 21-6614(e) never-expunge list even as a misdemeanor -> never (surprise-no).',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 7',
    package: 'currently registered sex offender, otherwise-eligible old theft felony -> blocked by the KORA gate.',
    record: { title: 'Registered offender, old theft felony', charge_type: 'felony', disposition: 'convicted', disposition_date: '2010-06-01', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: true },
    expect: {
      resultKey: 'ineligible_kora_ks',
      reading: 'While Kansas Offender Registration Act registration is required, NOTHING can be expunged (21-6614(f)) — the gate blocks even an otherwise-eligible old felony.',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 8',
    package: 'first DUI diversion, fulfilled 4 years ago -> not yet, 5-yr DUI rule despite diversion.',
    record: { title: 'First DUI diversion', charge_type: 'misdemeanor', disposition: 'deferred' },
    answers: { entry_ks: 'record', diversion_route_ks: true, dui_offense_ks: 'first', date5_ks: '2022-06-01' },
    expect: {
      resultKey: 'waiting_ks',
      reading: 'A first DUI, INCLUDING a diversion, is the 5-year tier (21-6614(d)); fulfilled 2022-06-01, only ~4 years at 2026-07-15 -> waiting (the diversion does not shorten the DUI wait to 3).',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 9',
    package: 'second DUI, completed 8 years ago -> not yet, 10-yr.',
    record: { title: 'Second DUI', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: false, never_list_ks: false, municipal_ks: false, survivor_ks: false, specialty_ks: false, recent_felony_ks: false, dui_ks: true, dui_offense_ks: 'second', dateDUI2_ks: '2018-06-01' },
    expect: {
      resultKey: 'waiting_ks',
      reading: 'A second-or-subsequent DUI carries a flat 10-year wait (21-6614(d), replacing the draft 7-10 range); completed 2018-06-01, only 8 years at 2026-07-15 -> waiting.',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 10',
    package: 'felony conviction expunged, asks about gun rights -> fully restored, NICS withdrawal.',
    record: { title: 'Expunged felony — gun-rights question', disposition: 'convicted' },
    answers: { entry_ks: 'effects', effects_ks: 'firearms' },
    expect: {
      resultKey: 'effects_firearms_ks',
      reading: 'Expungement of a disqualifying record fully restores firearm rights (21-6614(k)(2)), retroactively, with KBI/NICS withdrawal — contrasted with the sentencing-use carve-out.',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 11',
    package: 'felony conviction within past 2 years of petition on an old case -> fails (h)(1)(A).',
    record: { title: 'Old case, recent felony conviction', charge_type: 'felony', disposition: 'convicted', disposition_date: '2012-06-01', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: false, never_list_ks: false, municipal_ks: false, survivor_ks: false, specialty_ks: false, recent_felony_ks: true },
    expect: {
      resultKey: 'ineligible_recentfelony_ks',
      reading: 'A felony conviction in the past 2 years (or a pending felony) fails the discretionary standard (21-6614(h)(1)(A)) regardless of how old the target case is -> blocked for now.',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 12',
    package: 'drug-court graduate -> immediate petition, waivable fee.',
    record: { title: 'Drug-court graduate', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: false, never_list_ks: false, municipal_ks: false, survivor_ks: false, specialty_ks: true },
    expect: {
      resultKey: 'eligible_specialty_ks',
      reading: 'A 20-173 specialty-court graduate may petition immediately (21-6614(a)(3)), the docket fee is waivable, and only the no-pending-felony part of the standard applies -> eligible now.',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 13',
    package: 'prostitution conviction under coercion, 18 months out -> survivor path eligible.',
    record: { title: 'Prostitution conviction under coercion', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: false, never_list_ks: false, municipal_ks: false, survivor_ks: true, survivor_date_ks: '2025-01-15' },
    expect: {
      resultKey: 'eligible_survivor_ks',
      reading: 'A prostitution conviction committed under coercion has a 1-year path (21-6614(b)); sentence satisfied 2025-01-15, over a year before 2026-07-15 -> eligible.',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 14',
    package: 'arrested, charges dismissed -> 22-2410 petition, NO docket fee.',
    record: { title: 'Arrest, charges dismissed', disposition: 'dismissed' },
    answers: { entry_ks: 'arrest', arrest_type_ks: 'dismissed_bij' },
    expect: {
      resultKey: 'eligible_arrest_bij_ks',
      reading: 'An arrest with dismissed charges is expungeable under 22-2410, and a dismissal filing carries no docket fee (22-2410(b)(3)(B)).',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 15',
    package: 'mistaken-identity arrest -> prosecutor-initiated mandatory purge, no fee.',
    record: { title: 'Mistaken-identity arrest', disposition: 'dismissed' },
    answers: { entry_ks: 'arrest', arrest_type_ks: 'mistaken' },
    expect: {
      resultKey: 'eligible_arrest_mandatory_ks',
      reading: 'A mistaken-identity/identity-theft arrest with dismissed/unprosecuted charges triggers the mandatory prosecutor-initiated petition and KBI purge from all databases (22-2410(a)(2)), no fee.',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 16',
    package: 'municipal ordinance theft conviction, 3.5 years -> eligible in municipal court, city-set fee note.',
    record: { title: 'City-ordinance theft conviction', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ks: 'record', kora_gate_ks: false, never_list_ks: false, municipal_ks: true, municipal_route_ks: 'ordinary', municipal_date3_ks: '2023-01-01' },
    expect: {
      resultKey: 'eligible_municipal_ks',
      reading: 'A city-ordinance conviction is expunged in municipal court (12-4516), 3-year tier; satisfied 2023-01-01, past 3 years at 2026-07-15 -> eligible, with the per-city fee noted (12-4516(g)(2)).',
    },
    now: NOW,
  },
  {
    source: 'KS statute verification (2026-07-22) — persona 17',
    package: 'applicant for insurance-producer license with an expunged insurance-fraud diversion -> must disclose (HB 2323).',
    record: { title: 'Insurance-producer applicant, expunged fraud diversion', disposition: 'deferred' },
    answers: { entry_ks: 'effects', effects_ks: 'disclosure' },
    expect: {
      resultKey: 'effects_disclosure_ks',
      reading: '2026 HB 2323 added insurance-producer/public-adjuster license applications (for a fraudulent insurance act) to the 21-6614(i)(2) mandatory-disclosure list -> the expunged record must be disclosed on that application.',
    },
    now: NOW,
  },
];

// NM personas come from Diana's read of NMSA 1978 §§ 29-3A-1 to 29-3A-9 (the
// complete Criminal Record Expungement Act) via nmonesource.com — the statute-
// verified rewrite that took NM to statute_cited on 2026-07-22, replacing the
// Wave 6 draft's five personas. Conviction date nodes are asked (the clock runs
// from the MOST RECENT sentence completion for any conviction, not disposition_date).
const NM: Persona[] = [
  {
    source: 'NM statute verification (2026-07-22) — persona 1',
    package: 'misdemeanor shoplifting, sentence done, 2.5 conviction-free years -> eligible.',
    record: { title: 'Misdemeanor shoplifting', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_nm: 'record', excluded_nm: false, petition_gate_nm: true, restitution_gate_nm: true, household_nm: false, level_nm: 'misd', date2_nm: '2024-01-01' },
    expect: {
      resultKey: 'eligible_conviction_nm',
      reading: 'A misdemeanor sits in the 2-year tier (§ 29-3A-5); most recent completion 2024-01-01, past 2 conviction-free years at 2026-07-15 -> eligible.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 2',
    package: 'misdemeanor battery against a household member, 3 years clean -> NOT eligible — 10-yr Household Members Act tier (the trap persona).',
    record: { title: 'Misdemeanor DV battery (household member)', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_nm: 'record', excluded_nm: false, petition_gate_nm: true, restitution_gate_nm: true, household_nm: true, date10_nm: '2023-06-01' },
    expect: {
      resultKey: 'waiting_nm',
      reading: 'ANY Crimes Against Household Members Act offense is the 10-year tier regardless of degree (§ 29-3A-5); a misdemeanor DV waits 10 years, not 2 — 3 clean years is not enough -> waiting (the trap).',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 3',
    package: 'misdemeanor aggravated battery 30-3-5(B), 5 years clean -> eligible, 4-yr tier.',
    record: { title: 'Misdemeanor aggravated battery (30-3-5(B))', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_nm: 'record', excluded_nm: false, petition_gate_nm: true, restitution_gate_nm: true, household_nm: false, level_nm: 'deg4', date4_nm: '2021-01-01' },
    expect: {
      resultKey: 'eligible_conviction_nm',
      reading: 'Misdemeanor aggravated battery under 30-3-5(B) sits in the 4-year tier (§ 29-3A-5); most recent completion 2021-01-01, past 4 years at 2026-07-15 -> eligible.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 4',
    package: 'fourth-degree felony, 3 years clean -> not yet.',
    record: { title: '4th-degree felony', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_nm: 'record', excluded_nm: false, petition_gate_nm: true, restitution_gate_nm: true, household_nm: false, level_nm: 'deg4', date4_nm: '2023-06-01' },
    expect: {
      resultKey: 'waiting_nm',
      reading: 'A 4th-degree felony sits in the 4-year tier; most recent completion 2023-06-01, only 3 years at 2026-07-15 -> waiting.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 5',
    package: 'second-degree felony, 9 years clean -> eligible.',
    record: { title: '2nd-degree felony', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_nm: 'record', excluded_nm: false, petition_gate_nm: true, restitution_gate_nm: true, household_nm: false, level_nm: 'deg2', date8_nm: '2017-01-01' },
    expect: {
      resultKey: 'eligible_conviction_nm',
      reading: 'A 2nd-degree felony sits in the 8-year tier; most recent completion 2017-01-01, past 8 years at 2026-07-15 -> eligible.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 6',
    package: 'third-degree felony 7 years out, but a new misdemeanor sentence completed 1 year ago -> clock reset — not eligible until 6 conviction-free years from the newest completion.',
    record: { title: '3rd-degree felony (with newer misdemeanor)', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_nm: 'record', excluded_nm: false, petition_gate_nm: true, restitution_gate_nm: true, household_nm: false, level_nm: 'deg3', date6_nm: '2025-06-01' },
    expect: {
      resultKey: 'waiting_nm',
      reading: 'The conviction-free clock resets to the most recent sentence completion for ANY conviction (§ 29-3A-5(F)); the newer misdemeanor finished 2025-06-01, so the 6-year 3rd-degree clock has only run ~1 year -> waiting despite 7 years since the felony.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 7',
    package: 'embezzlement -> never.',
    record: { title: 'Embezzlement', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_nm: 'record', excluded_nm: true },
    expect: {
      resultKey: 'ineligible_excluded_nm',
      reading: 'Embezzlement (30-16-8) is on the § 29-3A-5(G) never-list — the surprise-no, as in Mississippi.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 8',
    package: 'DWI -> never.',
    record: { title: 'DWI', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_nm: 'record', excluded_nm: true },
    expect: {
      resultKey: 'ineligible_excluded_nm',
      reading: 'ANY DWI offense is on the § 29-3A-5(G) never-list (and TRD-kept DWI citations survive expungement anyway) -> never.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 9',
    package: 'felony that caused great bodily harm -> never.',
    record: { title: 'Felony causing great bodily harm', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_nm: 'record', excluded_nm: true },
    expect: {
      resultKey: 'ineligible_excluded_nm',
      reading: 'An offense that caused great bodily harm or death is on the § 29-3A-5(G) never-list -> never.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 10',
    package: 'fines paid but restitution outstanding -> fails C(3).',
    record: { title: 'Felony, restitution outstanding', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_nm: 'record', excluded_nm: false, petition_gate_nm: true, restitution_gate_nm: false },
    expect: {
      resultKey: 'ineligible_restitution_nm',
      reading: 'Victim restitution is a distinct grant criterion (§ 29-3A-5(C)) from the state fines/fees petition gate; state money paid but restitution outstanding fails it -> not yet.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 11',
    package: 'charges dismissed 14 months ago -> non-conviction shall-grant.',
    record: { title: 'Dismissed charge', disposition: 'dismissed', disposition_date: '2025-05-01' },
    answers: { entry_nm: 'record' },
    expect: {
      resultKey: 'eligible_nonconv_nm',
      reading: 'A non-conviction clears 1 year after final disposition and the court SHALL grant (§ 29-3A-4); dismissed 2025-05-01, 14 months before 2026-07-15 -> eligible.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 12',
    package: 'conditional discharge under 31-20-13, completed -> non-conviction route, 1-yr from disposition.',
    record: { title: 'Conditional discharge (31-20-13) completed', disposition: 'deferred', disposition_date: '2024-06-01' },
    answers: { entry_nm: 'record' },
    expect: {
      resultKey: 'eligible_nonconv_nm',
      reading: 'A conditional discharge under 31-20-13 routes as a non-conviction (§ 29-3A-4); completed 2024-06-01, over a year before 2026-07-15 -> eligible.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 13',
    package: '2019 cannabis-possession conviction, cannabis-only record -> automatically expunged with destruction; verify via AOC.',
    record: { title: 'Cannabis-only possession conviction (2019)', disposition: 'convicted', disposition_date: '2019-06-01' },
    answers: { entry_nm: 'cannabis', cannabis_route_nm: 'only' },
    expect: {
      resultKey: 'eligible_cannabis_auto_nm',
      reading: 'A cannabis-only record for now-legal conduct is automatically expunged with DESTRUCTION 2 years after conviction (§ 29-3A-8); the messaging tells the user to verify via the AOC rather than assume.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 14',
    package: '2018 arrest with cannabis + shoplifting charges -> AOC administrative request for the cannabis portion.',
    record: { title: 'Mixed cannabis + shoplifting arrest (2018)', disposition: 'dismissed', disposition_date: '2018-06-01' },
    answers: { entry_nm: 'cannabis', cannabis_route_nm: 'mixed' },
    expect: {
      resultKey: 'eligible_cannabis_mixed_nm',
      reading: 'The automatic path reaches only cannabis-only records; a mixed record uses the § 29-3A-8(C) AOC administrative request for the cannabis charges, with the rest screened separately.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 15',
    package: 'identity-theft victim -> 3A-3 mandatory path.',
    record: { title: 'Identity-theft victim', disposition: 'unknown' },
    answers: { entry_nm: 'identity' },
    expect: {
      resultKey: 'eligible_identity_nm',
      reading: 'On a showing of identity theft the district court SHALL expunge all arrest and public records within 30 days (§ 29-3A-3) — a dedicated mandatory route independent of any waiting period.',
    },
    now: NOW,
  },
  {
    source: 'NM statute verification (2026-07-22) — persona 16',
    package: 'applying for a job at a FINRA-regulated brokerage with an expunged conviction -> must disclose.',
    record: { title: 'FINRA-regulated job applicant, expunged conviction', disposition: 'convicted' },
    answers: { entry_nm: 'effects' },
    expect: {
      resultKey: 'effects_disclosure_nm',
      reading: 'The single § 29-3A-7 disclosure carve-out is employment or association with a FINRA- or SEC-regulated financial institution, so an expunged record must be disclosed for a FINRA-regulated brokerage job.',
    },
    now: NOW,
  },
];

// NE personas come from Diana's read of Neb. Rev. Stat. §§ 29-2264 (through Laws
// 2024, LB 20), 29-3523 (through Laws 2019, LB 686), and 29-3528 from
// nebraskalegislature.gov — the statute-verified rewrite that took NE to
// statute_cited on 2026-07-22, replacing the Wave 6 draft's five personas. The two
// tiers: convictions get only a set-aside (record stays public), non-convictions
// come off the record automatically with a strong honest-no.
const NE: Persona[] = [
  {
    source: 'NE statute verification (2026-07-22) — persona 1',
    package: 'felony theft, probation completed last month, fines paid -> set-aside eligible NOW, with record-stays-public messaging.',
    record: { title: 'Felony theft, probation completed', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ne: 'conviction', conviction_route_ne: false, trafficking_ne: false, sentence_ne: 'pathA', pathA_complete_ne: true },
    expect: {
      resultKey: 'eligible_setaside_a_ne',
      reading: 'A completed probation sentence is Path A (§ 29-2264(2)): no waiting period, eligible on completion. The result states the honest "record stays public, no honest-no" caveat.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 2',
    package: 'misdemeanor assault, 6-month jail sentence completed -> Path B eligible (LB 20).',
    record: { title: 'Misdemeanor assault, 6-month jail', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'none' },
    answers: { entry_ne: 'conviction', conviction_route_ne: false, trafficking_ne: false, sentence_ne: 'pathB', pathB_mv_ne: false, pathB_pending_ne: false, pathB_sora_ne: false, pathB_refile_ne: false, pathB_complete_ne: true },
    expect: {
      resultKey: 'eligible_setaside_b_ne',
      reading: 'A completed sentence of one year or less of imprisonment with none of the four Path B bars is eligible under § 29-2264(3) (added by LB 20, 2024).',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 3',
    package: 'felony with an 18-month prison sentence -> no set-aside path; pardon only.',
    record: { title: 'Felony, 18-month prison', charge_type: 'felony', disposition: 'convicted', prison_sentenced: true },
    answers: { entry_ne: 'conviction', conviction_route_ne: false, trafficking_ne: false, sentence_ne: 'long_prison' },
    expect: {
      resultKey: 'ineligible_prison_ne',
      reading: 'More than one year of imprisonment is beyond both set-aside paths (§ 29-2264); pardon only, and a pardon can then be sealed.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 4',
    package: 'DUI with probation, completed -> Path A, no motor-vehicle bar, discretionary.',
    record: { title: 'DUI, probation completed', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_ne: 'conviction', conviction_route_ne: false, trafficking_ne: false, sentence_ne: 'pathA', pathA_complete_ne: true },
    expect: {
      resultKey: 'eligible_setaside_a_ne',
      reading: 'The motor-vehicle bar attaches only to Path B; a DUI sentenced to probation qualifies under Path A (§ 29-2264(2)) with no motor-vehicle bar, discretionary.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 5',
    package: 'DUI with 30-day jail sentence -> Path B barred by (3)(b)(iii).',
    record: { title: 'DUI, 30-day jail', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'none' },
    answers: { entry_ne: 'conviction', conviction_route_ne: false, trafficking_ne: false, sentence_ne: 'pathB', pathB_mv_ne: true },
    expect: {
      resultKey: 'ineligible_pathb_mv_ne',
      reading: 'A DUI with a jail sentence goes to Path B, where the motor-vehicle bar (§ 29-2264(3)(b)(iii)) applies -> barred (the asymmetry with persona 4).',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 6',
    package: 'reckless-driving conviction, 9-month sentence -> Path B barred (Rules of the Road).',
    record: { title: 'Reckless driving, 9-month sentence', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'none' },
    answers: { entry_ne: 'conviction', conviction_route_ne: false, trafficking_ne: false, sentence_ne: 'pathB', pathB_mv_ne: true },
    expect: {
      resultKey: 'ineligible_pathb_mv_ne',
      reading: 'Reckless driving is a Rules-of-the-Road offense, so a jail-sentenced (Path B) reckless-driving conviction hits the motor-vehicle bar (§ 29-2264(3)(b)(iii)) -> barred.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 7',
    package: 'Path B petitioner with a charge pending in Canada -> mandatory denial.',
    record: { title: 'Path B, charge pending in Canada', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'none' },
    answers: { entry_ne: 'conviction', conviction_route_ne: false, trafficking_ne: false, sentence_ne: 'pathB', pathB_mv_ne: false, pathB_pending_ne: true },
    expect: {
      resultKey: 'ineligible_pathb_pending_ne',
      reading: 'A charge pending in any court in the U.S. OR another country is a mandatory Path B denial (§ 29-2264(3)(b)(i)) — a charge in Canada counts.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 8',
    package: 'Path B denial 14 months ago -> wait until 2 years.',
    record: { title: 'Path B, denied 14 months ago', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'none' },
    answers: { entry_ne: 'conviction', conviction_route_ne: false, trafficking_ne: false, sentence_ne: 'pathB', pathB_mv_ne: false, pathB_pending_ne: false, pathB_sora_ne: false, pathB_refile_ne: true },
    expect: {
      resultKey: 'ineligible_pathb_refile_ne',
      reading: 'Filing within 2 years of a prior Path B denial is a mandatory denial (§ 29-2264(3)(b)(iv)); 14 months is inside the window -> wait.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 9',
    package: 'registered sex offender seeking set-aside of an old theft -> barred during registration (Path B) and registration duty survives regardless.',
    record: { title: 'Registered offender, old theft (Path B)', charge_type: 'felony', disposition: 'convicted', probation_status: 'none' },
    answers: { entry_ne: 'conviction', conviction_route_ne: false, trafficking_ne: false, sentence_ne: 'pathB', pathB_mv_ne: false, pathB_pending_ne: false, pathB_sora_ne: true },
    expect: {
      resultKey: 'ineligible_pathb_sora_ne',
      reading: 'Current SORA registration is a mandatory Path B denial regardless of the target offense (§ 29-2264(3)(b)(ii)); the result also notes the registration duty survives a set-aside.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 10',
    package: 'set-aside granted, asks "can I say I was never convicted?" -> NO — no honest-no; record public; must answer truthfully.',
    record: { title: 'Set-aside granted, honest-no question', disposition: 'convicted' },
    answers: { entry_ne: 'effects', effects_ne: 'honestno' },
    expect: {
      resultKey: 'effects_honestno_ne',
      reading: 'A set-aside leaves the conviction public with NO honest-no (§ 29-2264); the strong honest-no belongs to SEALED records (§ 29-3523(8)) -> must answer truthfully.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 11',
    package: 'set-aside granted, asks about gun rights -> attorney-consult warning; 28-1206 still applies.',
    record: { title: 'Set-aside granted, firearms question', disposition: 'convicted' },
    answers: { entry_ne: 'effects', effects_ne: 'firearms' },
    expect: {
      resultKey: 'effects_firearms_ne',
      reading: 'A set-aside does not restore firearm rights; the order must advise consulting an attorney, and the state felon-in-possession law (§ 28-1206) still applies (federal law may still count it, U.S. v. Germaine).',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 12',
    package: 'charges dismissed 2019 -> already sealed automatically at dismissal; honest-no applies; if still appearing, 29-3528 enforcement note.',
    record: { title: 'Charges dismissed 2019', disposition: 'dismissed', disposition_date: '2019-06-01' },
    answers: { entry_ne: 'nonconv', nonconv_route_ne: 'dismissed', dismissal_era_ne: true },
    expect: {
      resultKey: 'eligible_removed_immediate_ne',
      reading: 'A post-1/1/2017 dismissal is removed from public access immediately by operation of law (§ 29-3523(3)(c)), with the strong honest-no; if it lingers, the fix is a separate § 29-3528 action.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 13',
    package: 'charges dismissed 2015 -> motion required under (6).',
    record: { title: 'Charges dismissed 2015', disposition: 'dismissed', disposition_date: '2015-06-01' },
    answers: { entry_ne: 'nonconv', nonconv_route_ne: 'dismissed', dismissal_era_ne: false },
    expect: {
      resultKey: 'complex_pre2017_ne',
      reading: 'A dismissal before 1/1/2017 is not automatic — it needs a motion, and on finding it qualifies the court SHALL seal (§ 29-3523(6)).',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 14',
    package: 'completed diversion, no charges filed, 30 months out -> removed at 2 years.',
    record: { title: 'Completed diversion, no charges', disposition: 'deferred' },
    answers: { entry_ne: 'nonconv', nonconv_route_ne: 'diversion', diversion_date_ne: '2024-01-01' },
    expect: {
      resultKey: 'eligible_removed_2yr_ne',
      reading: 'A diversion that kept charges from being filed is removed 2 years after arrest/citation/referral (§ 29-3523(3)(b)); arrest 2024-01-01, 30 months before 2026-07-15 -> removed.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 15',
    package: 'declination, 8 months out -> not yet, 1-yr.',
    record: { title: 'Prosecutor declination', disposition: 'dismissed' },
    answers: { entry_ne: 'nonconv', nonconv_route_ne: 'declination', declination_date_ne: '2025-11-15' },
    expect: {
      resultKey: 'waiting_declination_ne',
      reading: 'A prosecutor declination is removed 1 year after arrest/citation/referral (§ 29-3523(3)(a)); arrest 2025-11-15, only 8 months before 2026-07-15 -> not yet.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 16',
    package: 'pardoned conviction -> shall-seal motion.',
    record: { title: 'Pardoned conviction', disposition: 'convicted', disposition_date: '2012-06-01' },
    answers: { entry_ne: 'conviction', conviction_route_ne: true },
    expect: {
      resultKey: 'eligible_pardoned_ne',
      reading: 'A pardoned person may move the sentencing court and the court SHALL seal (§ 29-3523(5)) — one of Nebraska\'s only conviction-concealment routes.',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 17',
    package: 'arrested due to police error -> clear-and-convincing expungement petition.',
    record: { title: 'Arrest from law-enforcement error', disposition: 'dismissed' },
    answers: { entry_ne: 'le_error' },
    expect: {
      resultKey: 'eligible_leerror_ne',
      reading: 'An arrest caused by law-enforcement-agency error can be truly expunged via a district-court petition in the county of arrest on clear-and-convincing proof (§ 29-3523(9)).',
    },
    now: NOW,
  },
  {
    source: 'NE statute verification (2026-07-22) — persona 18',
    package: 'deferred judgment entered and completed -> immediate removal at dismissal.',
    record: { title: 'Completed deferred judgment', disposition: 'deferred' },
    answers: { entry_ne: 'nonconv', nonconv_route_ne: 'deferred_judgment' },
    expect: {
      resultKey: 'eligible_removed_immediate_ne',
      reading: 'A completed deferred judgment is expressly among the § 29-3523(3)(c) immediate-removal dispositions -> off the public record at dismissal.',
    },
    now: NOW,
  },
];

// ID personas come from Diana's read of I.C. § 19-2604 (through 2017 ch. 172) and
// § 67-3004 (through 2023 ch. 108) from legislature.idaho.gov — the statute-verified
// rewrite that took ID to statute_cited on 2026-07-22, replacing the Wave 6 draft's
// five personas. Idaho runs four remedies: dismissal/set-aside, felony reduction,
// shielding (the only conviction honest-no), and ISP non-conviction expungement.
const ID: Persona[] = [
  {
    source: 'ID statute verification (2026-07-22) — persona 1',
    package: 'felony withheld judgment, probation completed with zero violations -> dismissal-eligible now; record-stays-public messaging.',
    record: { title: 'Felony withheld judgment, clean probation', charge_type: 'felony', disposition: 'deferred', probation_status: 'completed' },
    answers: { entry_id: 'dismissal', dismiss_sexbar_id: false, dismiss_probation_id: false },
    expect: {
      resultKey: 'eligible_dismiss_id',
      reading: 'A completed withheld judgment with no found/admitted probation violation is § 19-2604(1) dismissal-eligible; the result states the vacatur-not-concealment / record-stays-public caveat.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 2',
    package: 'same but one admitted probation violation in year 2 -> permanently barred from (1); route to reduction/shielding analysis.',
    record: { title: 'Felony probation, admitted violation', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_id: 'dismissal', dismiss_sexbar_id: false, dismiss_probation_id: true, dismiss_drugcourt_id: false },
    expect: {
      resultKey: 'ineligible_dismiss_violation_id',
      reading: 'A found/admitted probation violation permanently bars § 19-2604(1) (no drug/mental-health-court bypass here); the result routes to reduction/shielding.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 3',
    package: 'probationer with a PAROLE violation on a different case -> not precluded (5).',
    record: { title: 'Clean probation; parole violation elsewhere', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_id: 'dismissal', dismiss_sexbar_id: false, dismiss_probation_id: false },
    expect: {
      resultKey: 'eligible_dismiss_id',
      reading: 'Per § 19-2604(5), parole/supervision-agreement violations do NOT preclude relief; a parole violation on another case does not count as a probation violation on this one -> dismissal-eligible.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 4',
    package: 'drug-court graduate with a pre-graduation violation -> bypass applies if post-graduation probation clean.',
    record: { title: 'Drug-court graduate, pre-graduation violation', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_id: 'dismissal', dismiss_sexbar_id: false, dismiss_probation_id: true, dismiss_drugcourt_id: true },
    expect: {
      resultKey: 'eligible_dismiss_id',
      reading: 'Successful drug/mental-health-court graduation with a clean post-graduation record is the sole bypass of the probation-violation bar -> dismissal-eligible.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 5',
    package: 'felony grand theft, discharged from probation 3 years ago, prosecutor won\'t stipulate -> reduction unavailable until 5 years.',
    record: { title: 'Felony grand theft, discharged 3 yrs', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_id: 'reduction', reduce_sexbar_id: false, reduce_laterfelony_id: false, reduce_years_id: 'under5', reduce_stip_id: false },
    expect: {
      resultKey: 'ineligible_reduce_nostip_id',
      reading: 'Within 5 years of discharge, a § 19-2604(3) reduction always requires prosecutor stipulation; with no stipulation it is a "not yet" until 5 years pass.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 6',
    package: 'robbery, discharged 7 years ago -> reduction only WITH stipulation (serious list).',
    record: { title: 'Robbery, discharged 7 yrs', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_id: 'reduction', reduce_sexbar_id: false, reduce_laterfelony_id: false, reduce_years_id: 'over5', reduce_seriouslist_id: true },
    expect: {
      resultKey: 'complex_reduce_seriousstip_id',
      reading: 'Robbery is on the 15-item serious list, so even 7 years past discharge a § 19-2604(3) reduction still requires prosecutor stipulation — but it remains possible (no offense is absolutely barred except a registrable sex offense).',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 7',
    package: 'burglary, discharged 6 years ago, no later felonies -> reduction eligible without stipulation.',
    record: { title: 'Burglary, discharged 6 yrs', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_id: 'reduction', reduce_sexbar_id: false, reduce_laterfelony_id: false, reduce_years_id: 'over5', reduce_seriouslist_id: false },
    expect: {
      resultKey: 'eligible_reduce_id',
      reading: 'Burglary is not on the serious list; 5+ years past discharge with no later-committed felony, no stipulation is needed (§ 19-2604(3)) -> reduction eligible.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 8',
    package: 'registrable sex offense with withheld judgment -> barred from everything in 19-2604.',
    record: { title: 'Registrable sex offense, withheld judgment', charge_type: 'felony', disposition: 'deferred' },
    answers: { entry_id: 'dismissal', dismiss_sexbar_id: true },
    expect: {
      resultKey: 'ineligible_sexbar_id',
      reading: 'A § 18-8304 registrable sex offense (including a withheld judgment) is barred from both dismissal and reduction under the whole of § 19-2604 (§ 19-2604(4)).',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 9',
    package: 'felony possession under 37-2732(c), sentence + fines done 6 years ago, clean -> SHIELDING eligible (surprise-yes).',
    record: { title: 'Felony possession (37-2732(c)), 6 yrs clean', charge_type: 'felony', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_id: 'shielding', shielding_type_id: 'felony_drug', shielding_prioruse_id: false, shielding_ro_id: false, shielding_clean_id: false, shielding_date_id: '2020-01-01' },
    expect: {
      resultKey: 'eligible_shielding_id',
      reading: 'Felony drug possession under § 37-2732(a)/(c)/(e) is expressly shieldable (the surprise-yes); full sentence completed 2020-01-01, 5+ conviction-free years by 2026-07-15, clean and no prior shielding -> eligible.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 10',
    package: 'misdemeanor domestic battery -> shielding barred (assaultive list).',
    record: { title: 'Misdemeanor domestic battery', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_id: 'shielding', shielding_type_id: 'violent_misd' },
    expect: {
      resultKey: 'ineligible_shield_violent_id',
      reading: 'Domestic battery is one of the 13 assaultive/violent misdemeanors excluded from shielding (§ 67-3004(11)) -> not shieldable.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 11',
    package: 'misdemeanor theft, 5+ years clean, but an active restraining order -> shielding barred at filing.',
    record: { title: 'Misdemeanor theft, active restraining order', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_id: 'shielding', shielding_type_id: 'nonviolent_misd', shielding_prioruse_id: false, shielding_ro_id: true },
    expect: {
      resultKey: 'ineligible_shield_ro_id',
      reading: 'A restraining order in effect at filing bars shielding (§ 67-3004(11)) — an unusual gate; it is a "not yet" until the order lifts.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 12',
    package: 'shielding granted, later felony conviction -> mandatory revocation on request.',
    record: { title: 'Shielding granted, later felony', disposition: 'convicted' },
    answers: { entry_id: 'effects', effects_id: 'revoke' },
    expect: {
      resultKey: 'effects_revoke_id',
      reading: 'A subsequent felony conviction means the court SHALL revoke the shielding on the prosecutor\'s request at sentencing (a subsequent misdemeanor -> MAY revoke) (§ 67-3004(11)).',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 13',
    package: 'person who already used their one shielding -> never again.',
    record: { title: 'Prior shielding used', charge_type: 'misdemeanor', disposition: 'convicted', probation_status: 'completed' },
    answers: { entry_id: 'shielding', shielding_type_id: 'nonviolent_misd', shielding_prioruse_id: true },
    expect: {
      resultKey: 'ineligible_shield_prioruse_id',
      reading: 'Shielding is once per lifetime (§ 67-3004(11)); a prior granted shielding bars another -> never again.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 14',
    package: 'arrested, never charged, 14 months -> ISP written request + court-file sealing.',
    record: { title: 'Arrested, never charged (14 months)', disposition: 'dismissed' },
    answers: { entry_id: 'nonconv', nonconv_route_id: 'nocharge' },
    expect: {
      resultKey: 'eligible_isp_id',
      reading: 'An arrest not charged within a year is cleared by a written request to the Idaho State Police (§ 67-3004(10)), with optional court-file sealing — the cheapest, fastest path.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 15',
    package: 'charges dismissed via 19-2604(1) -> NOT eligible for ISP expungement; explain the vacatur-vs-concealment difference.',
    record: { title: 'Dismissed via § 19-2604(1)', disposition: 'dismissed' },
    answers: { entry_id: 'nonconv', nonconv_route_id: 'dismissed', nonconv_2604_id: true },
    expect: {
      resultKey: 'ineligible_isp_2604_id',
      reading: 'A § 19-2604(1) dismissal is expressly excluded from § 67-3004(10) ISP expungement — vacatur, not concealment; the record stays public. Shielding is the route if hiding it matters.',
    },
    now: NOW,
  },
  {
    source: 'ID statute verification (2026-07-22) — persona 16',
    package: 'shielded record, asked in a job interview -> may reply it never occurred; asked in a court proceeding -> must disclose.',
    record: { title: 'Shielded record, disclosure question', disposition: 'convicted' },
    answers: { entry_id: 'effects', effects_id: 'honestno' },
    expect: {
      resultKey: 'effects_honestno_id',
      reading: 'A shielded conviction is deemed never to have occurred and may be denied — except in a judicial proceeding and peace-officer licensing (§ 67-3004(11)): deny it in the interview, disclose it in court.',
    },
    now: NOW,
  },
];
...
const WY: Persona[] = [
  {
    ...
    package: 'misdemeanor theft, 6 years since sentence -> 5-yr met -> eligible, $100.',
    record: { title: 'Misdemeanor theft', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'misd', misd_prioruse_wy: false, misd_excluded_wy: false, misd_status_wy: false, misd_date_wy: '2020-06-01', misd_objection_wy: false },
    expect: { resultKey: 'eligible_misd_wy', reading: 'A non-excluded misdemeanor whose terms ended 2020-06 clears the 5-year wait by 2025 (NOW 2026) -> eligible, $100, once-per-lifetime bundle advice.' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 2',
    package: 'age-based status offense (MIP), terms ended 14 months ago -> 1-yr fast lane met.',
    record: { title: 'MIP (status offense)', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'misd', misd_prioruse_wy: false, misd_excluded_wy: false, misd_status_wy: true, misd_status_date_wy: '2025-05-01', misd_objection_wy: false },
    expect: { resultKey: 'eligible_misd_wy', reading: 'A status offense has a 1-year wait; terms ended 2025-05, over a year before NOW 2026-07 -> eligible via the fast lane.' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 3',
    package: 'misdemeanor firearm brandishing -> firearm-use exclusion, no carve-back -> never.',
    record: { title: 'Misdemeanor brandishing (firearm)', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'misd', misd_prioruse_wy: false, misd_excluded_wy: true },
    expect: { resultKey: 'ineligible_excluded_misd_wy', reading: 'A misdemeanor involving use of a firearm is excluded from § 7-13-1501 with no carve-back -> ineligible (pardon route only).' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 4',
    package: 'felony forgery, restitution finished 2019 -> 10-yr clock runs from 2019 (not eligible until 2029).',
    record: { title: 'Felony forgery', charge_type: 'felony', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'felony', felony_prioruse_wy: false, felony_excluded_wy: false, felony_history_wy: false, felony_date_wy: '2019-03-01' },
    expect: { resultKey: 'waiting_felony_wy', reading: 'The felony clock runs from the LATER of sentence/program/restitution — restitution finished 2019-03, so 10 years lands in 2029; at NOW 2026 it is not met (the restitution-anchor trap).' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 5',
    package: 'felony drug possession, 11 years since sentence, no other felonies -> eligible, $300, firearm rights restored (state).',
    record: { title: 'Felony drug possession', charge_type: 'felony', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'felony', felony_prioruse_wy: false, felony_excluded_wy: false, felony_history_wy: false, felony_date_wy: '2015-01-01', felony_objection_wy: false },
    expect: { resultKey: 'eligible_felony_wy', reading: 'A non-excluded drug-possession felony (not distribution), single occurrence, no other felony history, 11 years past completion -> eligible; § 1502(m) restores state firearm rights with a federal-law attorney caveat.' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 6',
    package: 'two felonies from a single occurrence (one spree), 12 years past -> bundle -> eligible.',
    record: { title: 'Two same-occurrence felonies', charge_type: 'felony', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'felony', felony_prioruse_wy: false, felony_excluded_wy: false, felony_history_wy: false, felony_date_wy: '2014-01-01', felony_objection_wy: false },
    expect: { resultKey: 'eligible_felony_wy', reading: 'Related felonies from the SAME occurrence with no other felony history bundle into one petition; 12 years past completion -> eligible.' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 7',
    package: 'two felonies from different years/occurrences -> fails the one-felony-history limit -> never.',
    record: { title: 'Two felonies, different occurrences', charge_type: 'felony', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'felony', felony_prioruse_wy: false, felony_excluded_wy: false, felony_history_wy: true },
    expect: { resultKey: 'ineligible_felonyhistory_wy', reading: 'Wyoming expunges only single-occurrence felonies with no other felony history; felonies from different occurrences -> ineligible (honest-no).' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 8',
    package: 'game-and-fish felony involving a firearm but punishable under Title 23 -> firearm carve-back applies -> eligible.',
    record: { title: 'Title 23 game-and-fish felony (firearm)', charge_type: 'felony', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'felony', felony_prioruse_wy: false, felony_excluded_wy: false, felony_history_wy: false, felony_date_wy: '2010-01-01', felony_objection_wy: false },
    expect: { resultKey: 'eligible_felony_wy', reading: 'A firearm felony is excluded UNLESS punishable under Title 23 (game-and-fish); the carve-back applies, so the exclusion answer is no; 16 years past completion -> eligible.' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 9',
    package: 'violent felony (§ 6-1-104(a)(xii)) -> excluded -> never.',
    record: { title: 'Violent felony', charge_type: 'felony', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'felony', felony_prioruse_wy: false, felony_excluded_wy: true },
    expect: { resultKey: 'ineligible_excluded_felony_wy', reading: 'A violent felony under § 6-1-104(a)(xii) is on the exclusion list -> ineligible (pardon route only).' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 10',
    package: 'already used the once-per-lifetime felony expungement in 2020 -> never again.',
    record: { title: 'Second felony petition', charge_type: 'felony', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'felony', felony_prioruse_wy: true },
    expect: { resultKey: 'ineligible_prioruse_felony_wy', reading: 'Felony expungement is once per lifetime (§ 7-13-1502); a prior use in 2020 bars another -> ineligible.' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 11',
    package: 'arrest dropped 7 months ago, no charges pending -> free 180-day non-conviction path, may-deny.',
    record: { title: 'Dropped arrest', charge_type: 'misdemeanor', disposition: 'dismissed' },
    answers: { entry_wy: 'nonconv', nonconv_pending_wy: false, nonconv_date_wy: '2025-11-01' },
    expect: { resultKey: 'eligible_nonconv_wy', reading: 'A non-conviction with no charges pending clears the 180-day wait (2025-11 -> ~8 months before NOW) -> eligible; free, and § 1401(f) grants the may-deny right.' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 12',
    package: 'completed a § 7-13-301 first-offender deferral, dismissed -> BARRED from § 7-13-1401 -> attorney referral (open question).',
    record: { title: 'Completed first-offender deferral', charge_type: 'felony', disposition: 'dismissed' },
    answers: { entry_wy: 'deferral' },
    expect: { resultKey: 'complex_deferral_wy', reading: 'Deferral dispositions (§ 7-13-301 / § 35-7-1037 / former § 7-13-203) are excluded from § 7-13-1401 and the completer route is unsettled -> route to an attorney, do not guess.' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 13',
    package: 'health-care provider offense against a patient (§ 6-2-313) -> misdemeanor exclusion -> never.',
    record: { title: 'Health-care provider patient offense', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'misd', misd_prioruse_wy: false, misd_excluded_wy: true },
    expect: { resultKey: 'ineligible_excluded_misd_wy', reading: 'A health-care provider\'s offense against a patient (§ 6-2-313) is excluded from § 7-13-1501 -> ineligible (pardon route only).' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 14',
    package: 'expunged felony, asked "were you ever convicted?" -> no statutory denial right, attorney-tier (contrast the § 1401 non-conviction answer).',
    record: { title: 'Effect question — expunged felony', charge_type: 'felony', disposition: 'convicted' },
    answers: { entry_wy: 'effects', effects_split_wy: 'conviction' },
    expect: { resultKey: 'complex_effect_conviction_wy', reading: 'The conviction sections (§ 7-13-1501/1502) restore rights but do not grant the "may deny" language of § 1401(f) -> no clear denial right, route to an attorney.' },
    now: NOW,
  },
  {
    source: 'Wave 7 — WY persona 15',
    package: 'misdemeanor timing met but a victim objects -> hearing (substantial-danger standard).',
    record: { title: 'Misdemeanor with victim objection', charge_type: 'misdemeanor', disposition: 'convicted' },
    answers: { entry_wy: 'conviction', conv_level_wy: 'misd', misd_prioruse_wy: false, misd_excluded_wy: false, misd_status_wy: false, misd_date_wy: '2019-06-01', misd_objection_wy: true },
    expect: { resultKey: 'complex_objection_misd_wy', reading: 'The 5-year wait is met, but a victim objection within 30 days sends it to a hearing under the substantial-danger standard (§ 7-13-1501).' },
    now: NOW,
  },
];
